...
<img width="100%" src="assets/readme/progress-mini.svg" alt="CHECKOUT OF HELL project progress — 78.4% implemented/testable; demo release readiness tracked separately" />
...
Current weighted calculation: `(100 × 10%) + (99 × 25%) + (94 × 40%) + (30 × 20%) + (0 × 5%) = 78.35%`, displayed as **78.4%**. Geometry uses the unrounded `78.35%` fraction.
...
**Current demo-readiness gate:** finish an interactive target-Windows playtest of Closing Time, including save/load confirmation, balance/polish sign-off, and the remaining controller/performance passes before any public demo is published.
