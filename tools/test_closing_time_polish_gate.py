...
ROUTE_SIGNS = {
    ...
    17222: (((320.0, 285.0), (320.0, 420.0)), "ClosingTimeManagementRearSign", "MGSN", "MGSNA0.png"),
...
def main() -> int:
    ...
    # Deterministic project-owned route signs form two-stage breadcrumb chains for every breaker
    # and for the rear-management handoff, then mark both Overtime pressure lanes. Every instance
