...
rear_confirmation_signs = {(-320.0, 420.0), (320.0, 420.0)}
...
print(
    ...
    "the hard-only second ring remains sight-gated, and ambient Overtime reinforcements stay clear of the rear objective-confirmation sightline."
)
